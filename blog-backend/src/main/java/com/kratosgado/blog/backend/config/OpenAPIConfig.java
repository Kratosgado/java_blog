...
public class OpenAPIConfig {
  ...
  @Bean
  public GroupedOpenApi dataRestApi() {
    return GroupedOpenApi.builder().group("data-rest").pathsToMatch("/data/**").build();
  }
    ...
    return new OpenAPI()
        .info(
            new Info()
                ...
                .description(
                    "Comprehensive REST and GraphQL API for a blogging platform with Spring Boot 3")
                .version("1.0.0")
                .contact(
                    new Contact()
            ...
            new Components()
                .addParameters(
                    ...
                    new Parameter()
                        ...
                        .name("version")
                        .description("API version (?version=1.0 or ?version=2.0)")
                        .required(false)
                        .schema(
                            new StringSchema()
                                ._default("1.0")
