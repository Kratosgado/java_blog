 ...
 * Provides endpoints to view cache statistics and manually trigger cache operations.
 */
@RestController
...
public class CacheController {
  ...
  @Operation(
      ...
      description = "Retrieves statistics for all application caches. Requires admin role.",
  ...
  @Operation(
      ...
      description = "Refreshes the specified cache by reloading data. Requires admin role.",
      security = @SecurityRequirement(name = "bearer-jwt")
  )
  @PreAuthorize("hasRole('ADMIN')")
