...
public class PostController {
  ...
  @GetEnpoint
  public PageResponse<PostDetails> getPosts(@ParameterObject PageRequest page) {
  ...
  @GetEnpoint
  public PageResponse<PostDetails> searchPosts(@ParameterObject SearchPageRequest request) {
