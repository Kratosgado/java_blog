 ...
 *
 * <p>Test with: - ADMIN user: Access granted (200 OK) - AUTHOR user: Access granted (200 OK) -
 * READER user: Access denied (403 Forbidden) - No token: Unauthorized (401)
 */
@RestController
...
public class AuthorController {
  ...
  @SecuredGetEndpoint(
      ...
      description =
          "Retrieve posts created by the authenticated author. Requires AUTHOR or ADMIN role.",
