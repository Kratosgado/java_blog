...
public class CommentController {
  ...
  @SecuredUpdateEndpoint(summary = "Approve a comment", description = "Approves a pending comment. Requires authentication.", roles = {
  ...
  @SecuredUpdateEndpoint(summary = "Reject a comment", description = "Rejects a pending comment. Requires authentication.", roles = {
      UserRole.AUTHOR, UserRole.ADMIN })
