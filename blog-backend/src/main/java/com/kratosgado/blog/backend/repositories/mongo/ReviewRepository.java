...
public interface ReviewRepository extends MongoRepository<Review, String> {
  ...
  Page<ReviewResponse.ReviewWithoutUser> findByUserId(Long userId, Pageable pageable);
  ...
  List<ReviewResponse.AverageRatingResult> getAverageRatingByPostId(Long postId);
