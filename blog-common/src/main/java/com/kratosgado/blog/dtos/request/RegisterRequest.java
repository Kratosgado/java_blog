...
public record RegisterRequest(
    ...
    @NotBlank(message = "Password is required") @Size(min = 8, max = 30, message = "Password must be between 8 and 30 characters") @NotBlank(message = "Password is required") String password) {
}
