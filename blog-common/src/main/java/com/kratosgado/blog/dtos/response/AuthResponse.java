...
/**
 * Response DTO for authentication operations (login, register). Contains JWT token and essential
 * user information for client-side session management.
 */
...
public record AuthResponse(
    @Schema(
        ...
        String token,
    @Schema(description = "Unique user identifier", example = "1") Long userId,
