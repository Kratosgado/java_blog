...
public class PostApiClient extends BaseApiClient {
  ...
  public PageResponse<PostResponse.PostView> getAllPosts(int page, int size) throws IOException {
    ...
    Type pageResponseType =
        TypeToken.getParameterized(PageResponse.class, PostResponse.PostView.class).getType();
    return handleResponse(response, pageResponseType, "Get posts");
  }

  /** Get post by ID */
  public PostDetails getPostById(Long id) throws IOException {
    logger.info("Fetching post by ID: {}", id);

    HttpClient.HttpResponse<String> response =
        httpClient.get("/posts/" + id, authToken, String.class);

    return handleResponse(response, PostDetails.class, "Get post by ID");
  }
  ...
  public PageResponse<PostWithoutCategory> getPostsByCategory(Long categoryId, int page, int size)
    ...
    Type pageResponseType =
        TypeToken.getParameterized(PageResponse.class, PostWithoutCategory.class).getType();
    return handleResponse(response, pageResponseType, "Get posts by category");
  }

  /** Get posts by user */
  public PageResponse<PostWithoutUser> getPostsByUser(Long userId, int page, int size)
      throws IOException {
    ...
    Type pageResponseType =
        TypeToken.getParameterized(PageResponse.class, PostWithoutUser.class).getType();
  ...
  public PageResponse<PostResponse.PostView> searchPosts(String keyword, int page, int size)
    ...
    String endpoint =
        String.format("/posts/search?keyword=%s&page=%d&size=%d", keyword, page, size);
    HttpClient.HttpResponse<String> response = httpClient.get(endpoint, authToken, String.class);
  ...
  /** Create a new post */
  public PostDetails createPost(CreatePostRequest request) throws IOException {
    logger.info("Creating new post: {}", request.title());

    HttpClient.HttpResponse<String> response =
        httpClient.post("/posts", request, authToken, String.class);

    return handleResponse(response, PostDetails.class, "Create post");
  }

  /** Update an existing post */
  public PostDetails updatePost(Long id, UpdatePostRequest request) throws IOException {
    logger.info("Updating post ID: {}", id);

    HttpClient.HttpResponse<String> response =
        httpClient.put("/posts/" + id, request, authToken, String.class);

    return handleResponse(response, PostDetails.class, "Update post");
  }

  /** Publish a post */
  public PostDetails publishPost(Long id) throws IOException {
    logger.info("Publishing post ID: {}", id);
    HttpClient.HttpResponse<String> response =
        httpClient.put("/posts/" + id + "/publish", null, authToken, String.class);
    return handleResponse(response, PostDetails.class, "Publish post");
  }
  ...
  public void deletePost(Long id) throws IOException {
    ...
    HttpClient.HttpResponse<String> response =
        httpClient.delete("/posts/" + id, authToken, String.class);
